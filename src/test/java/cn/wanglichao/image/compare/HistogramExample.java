package cn.wanglichao.image.compare;
...
/**
 * Created by wanglichao on 14-1-21.
 */
public class HistogramExample {
    ...
    private Histogram getHistogram1(RenderedOp img,
        ...
        BufferedImage image = ImageIO.read(new File("/home/wanglichao/git/pica-pica/src/test/resources/test1.jpg"));
...
// Retrieve the histogram.
    ...
    public Histogram getHistogram() throws IOException {
        ...
        PlanarImage image = JAI.create("fileload", "/home/wanglichao/git/pica-pica/src/test/resources/test1.jpg");
        int numbands =   image.getSampleModel().getNumBands();
